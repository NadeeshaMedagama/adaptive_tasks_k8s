...
- **Containerization**: Docker, Docker Compose, and Kubernetes manifests
...
- ✅ **Kubernetes Manifests** — Ready-to-apply manifests for local cluster deployment
...
```yaml
- name: Deploy adaptive_tasks_k8s
  uses: <OWNER>/<REPO>@v1
  with:
